...
func IPInputAction(
	...
	cidr bool,
	file bool,
	actionStdin func(string, bool, bool),
	actionRange func(string),
	actionCidr func(string),
	actionFile func(string, bool, bool),
) error {
	// Handle stdin
	if stdin {
		...
		if isPiped || isTyping || stat.Size() > 0 {
			...
			for scanner.Scan() {
				...
				actionStdin(input, iprange, cidr)
			}
		}
	}
