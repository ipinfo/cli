...
```bash
curl -Ls https://github.com/ipinfo/cli/releases/download/ipinfo-3.1.1/macos.sh | sh
```
...
```bash
curl -Ls https://github.com/ipinfo/cli/releases/download/ipinfo-3.1.1/deb.sh | sh
```

OR

```bash
curl -LO https://github.com/ipinfo/cli/releases/download/ipinfo-3.1.1/ipinfo_3.1.1.deb
sudo dpkg -i ipinfo_3.1.1.deb
```
...
```bash
iwr -useb https://github.com/ipinfo/cli/releases/download/ipinfo-3.1.1/windows.ps1 | iex
```
...
```bash
docker run --rm -it ipinfo/ipinfo:3.1.1
```
...
```bash
docker run --rm -it -v "$PWD/ipinfo:/root/.config/ipinfo" ipinfo/ipinfo:3.1.1
```
...
curl -LO https://github.com/ipinfo/cli/releases/download/ipinfo-3.1.1/ipinfo_3.1.1_${PLAT}.tar.gz
# OR
wget https://github.com/ipinfo/cli/releases/download/ipinfo-3.1.1/ipinfo_3.1.1_${PLAT}.tar.gz

tar -xvf ipinfo_3.1.1_${PLAT}.tar.gz
mv ipinfo_3.1.1_${PLAT} /usr/local/bin/ipinfo
```
