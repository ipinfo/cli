...
```bash
curl -Ls https://github.com/ipinfo/cli/releases/download/ipinfo-2.5.0/macos.sh | sh
```

### Debian / Ubuntu (amd64)

```bash
curl -Ls https://github.com/ipinfo/cli/releases/download/ipinfo-2.5.0/deb.sh | sh
```
...
```bash
curl -LO https://github.com/ipinfo/cli/releases/download/ipinfo-2.5.0/ipinfo_2.5.0.deb
sudo dpkg -i ipinfo_2.5.0.deb
```
...
curl -LO https://github.com/ipinfo/cli/releases/download/ipinfo-2.5.0/ipinfo_2.5.0_${PLAT}.tar.gz
# OR
wget https://github.com/ipinfo/cli/releases/download/ipinfo-2.5.0/ipinfo_2.5.0_${PLAT}.tar.gz

tar -xvf ipinfo_2.5.0_${PLAT}.tar.gz
mv ipinfo_2.5.0_${PLAT} /usr/local/bin/ipinfo
```
...
| prips      | [1.0.1](https://github.com/ipinfo/cli/releases/tag/prips-1.0.1) |
