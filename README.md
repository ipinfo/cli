...
```bash
curl -Ls https://github.com/ipinfo/cli/releases/download/ipinfo-2.3.1/macos.sh | sh
```

### Debian / Ubuntu (amd64)

```bash
curl -Ls https://github.com/ipinfo/cli/releases/download/ipinfo-2.3.1/deb.sh | sh
```
...
```bash
curl -LO https://github.com/ipinfo/cli/releases/download/ipinfo-2.3.1/ipinfo_2.3.1.deb
sudo dpkg -i ipinfo_2.3.1.deb
```
...
curl -LO https://github.com/ipinfo/cli/releases/download/ipinfo-2.3.1/ipinfo_2.3.1_${PLAT}.tar.gz
# OR
wget https://github.com/ipinfo/cli/releases/download/ipinfo-2.3.1/ipinfo_2.3.1_${PLAT}.tar.gz

tar -xvf ipinfo_2.3.1_${PLAT}.tar.gz
mv ipinfo_2.3.1_${PLAT} /usr/local/bin/ipinfo
```
...
`range2cidr`, `randip` and `range2ip` which are also shipped as standalone binaries.
